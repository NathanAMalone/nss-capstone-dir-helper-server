...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('instrument', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='helperapi.instrument')),
            ],
        ),
        migrations.CreateModel(
            name='Uniform',
        ...
        migrations.AddField(
            model_name='student',
            name='prop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='helperapi.prop'),
        ),
        migrations.AddField(
            model_name='student',
            name='school',
        ...
        migrations.AddField(
            model_name='student',
            name='uniform',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='helperapi.uniform'),
        ),
        migrations.AddField(
            model_name='student',
            name='user',
